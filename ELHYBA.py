...
def send_welcome(message):
    ...
    developer_button = telebot.types.InlineKeyboardButton("Dav", url="https://t.me/B_8_K")
    ...
    try:
        if message.document.file_name.endswith('.py') or message.document.file_name.endswith('.php'):
            ...
            if code_content == corrected_code:
                ...
                final_message = "ارجو منك تقييم البوت وخبرني عن سبب تقييمك فضلا وليس امرا المطور @B_8_K"
